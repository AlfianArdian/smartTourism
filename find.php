...
<head>
  <meta charset='utf-8' />
  <title>Perkiraan Waktu Perjalanan</title>
...
<body>
  ...
  <div class="info-box">
    <div id="info">
      <p>gambarkan rutemu memakai alat gambar di sebelah kanan.dan gambarkan titik-titik yang ingin dituju.</p>
    </div>
  ...
  <script>
    ...
    function getInstructions(data) {
      ...
      directions.innerHTML = "<br><h2>Trip duration: " + Math.floor(data.duration / 60) + "min 🚗 mobil</h2>"  + tripDirections ;
    }
    ...
    var geojsone = {
              ...
              features: [
                // sukun
                {
                  ...
                  properties: {
                    title: '<?= $data['judul'];?>',
                    description: '<a href=\"#\" target=http://localhost/smartTourism/detail.php?idwisatane=1 title=\"Opens in a new window\">Visit Us</a>'
                  }
                },
              ]
            };
